...
2.  **Conversion**: For any non-Markdown files (`.pdf`, `.docx`, `.txt`), use appropriate conversion scripts to move them into the `reports/mystic_corpus/[alias]/docs/` folder as `00001.md`, `00002.md`, etc.
